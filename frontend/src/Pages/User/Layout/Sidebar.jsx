...
const Sidebar = () => {
    return (
        <nav className="bg-[#fcfcfc] shadow-lg h-screen fixed top-0 left-0 min-w-[250px] py-6 px-4 font-[sans-serif] overflow-auto">
            <a href="#"><img src="https://readymadeui.com/readymadeui.svg" alt="logo" className='w-[160px]' />
            </a>
            ...
            <div className="mt-6">
                <div className="flex cursor-pointer group">
                    <h6 className="text-gray-600 group-hover:text-black text-sm font-bold px-4 flex-1">Income</h6>
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-3 fill-gray-600 group-hover:fill-black -rotate-90"
                        viewBox="0 0 451.847 451.847">
                        <path
                            d="M225.923 354.706c-8.098 0-16.195-3.092-22.369-9.263L9.27 151.157c-12.359-12.359-12.359-32.397 0-44.751 12.354-12.354 32.388-12.354 44.748 0l171.905 171.915 171.906-171.909c12.359-12.354 32.391-12.354 44.744 0 12.365 12.354 12.365 32.392 0 44.751L248.292 345.449c-6.177 6.172-14.274 9.257-22.369 9.257z"
                            data-original="#000000" />
            ...
            <div className="mt-6">
                <div className="flex cursor-pointer group">
                    <h6 className="text-gray-600 group-hover:text-black text-sm font-bold px-4 flex-1">Actions</h6>
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-3 fill-gray-600 group-hover:fill-black -rotate-90"
                        viewBox="0 0 451.847 451.847">
                        <path
                            d="M225.923 354.706c-8.098 0-16.195-3.092-22.369-9.263L9.27 151.157c-12.359-12.359-12.359-32.397 0-44.751 12.354-12.354 32.388-12.354 44.748 0l171.905 171.915 171.906-171.909c12.359-12.354 32.391-12.354 44.744 0 12.365 12.354 12.365 32.392 0 44.751L248.292 345.449c-6.177 6.172-14.274 9.257-22.369 9.257z"
